    ...
    if (isset($_GET['login'])) { 
        if (isset($_GET['username']) && !empty($_GET['username']) && isset($_GET['password']) && !empty($_GET['password'])) {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo '<div class="d-flex flex-column justify-content-center align-items-center myBackground" style="height: 100vh;z-index:999; position:absolute; width:100%;height:135vh; padding-bottom:40vh;">
                <h3>Logging In</h3>

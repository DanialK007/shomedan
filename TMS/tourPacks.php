...
<body>
    ...
    <main>
        ...
        <div class="whiteDefault d-flex flex-column align-items-center justify-content-center pt-5">
            <h1 class="display-3 text-center mt-5 pt-4 mb-3">Tour Packages</h1>
        </div>
                        ...
                        <div class="card placesCard rounded-0 position-relative">
                            ...
                            <div class="cardCaption text-decoration-none">
                                <div class="overflow-hidden">
                                    ...
                                    <a href="booking.php?tourName=<?php echo urlencode($row['tourName']); ?>"  class="btn btn-success rounded-pill">Book now</a>
                                </div>
                            </div>

        ...
        <div class="row p-4">
            ...
            <div class="col-md-8 p-3">
                <div class="bg-success-subtle rounded rounded-4 p-4 border border-3 border-secondary">
                    ...
                    ?>
                    <h4><?php echo $row['bookingDate'];?></h4>
                    <p><?php echo "Package Type : " . $row['packageType'];?></p>
                    <p><?php echo "Tour Plan : " . $row['tourPlan'];?></p>
                    <p>You've booked a trip to --- for <?php echo $yearsDifference, $monthsDifference, $daysDifference;?></p>
                    <hr>
                    <?php
                        }}
                    ?>

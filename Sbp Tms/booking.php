...
if(isset($_SESSION['username'])) {
    ...
    $tourPlan =$_POST['tourPlan'];

    $booking_sql=  "INSERT INTO `booking` (tourID,user_id,bookingDate,startDate, endDate, packageType, tourPlan, status)
                    VALUES (?,?,NOW(),?,?,?,?,?)";
    
    $bookingInsert = $connection -> prepare($booking_sql);
        if($bookingInsert){

            $bookingInsert->bind_param("iissssi", $tourID, $user_id, $startDate, $endDate, $packageType, $tourPlan,$status);
                ...
                <div class="col-lg-6 col-md-8 col-sm-8 myForm rounded rounded-3 pt-4">
                    ...
                    <form action="" method="post" class="row px-3">
                        ...
                        <div class="col-md-6 py-3">
                            ...
                            <select required name="packageType" id="" class="form-control">
                        ...
                        <div class="col-md-6 py-3">
                            ...
                            <select required name="tourPlan" id="" class="form-control">
                                <option hidden value="">Please Select</option>
